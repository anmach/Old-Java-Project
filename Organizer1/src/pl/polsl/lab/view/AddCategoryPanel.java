...
public class AddCategoryPanel extends JPanel implements ActionListener{
    ...
    private final JButton addCategoryButton;
     ...
     /**
     * Costructor creating buttons and text field. Do stuff needed by swing for JPanel to work.
     * @param organ object of Organizer type, which contains all categories avalible.
     */
     ...
     * 
     * @return doWeRefresh - it exuals true if there was changes requiring refreshing frame
     */
