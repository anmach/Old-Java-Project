...
/**
 * Class representing frame containing panels with categories and for adding new category.
 *
 * @author Anna Mach
 * @version 1
 */
public class CategoriesFrame extends JFrame {
    ...
    /**
    * Costructor creating panels belonging to this frame and set options like size of frame.
    * 
    ...
    */
    ...
    /**
     * Method hiding panels and creating new versions of them in order to reset all text fields and add new categories. Then showing them again.
     */
    ...
    /**
     * Method which get's from categoriesPanel last chosen by user Category (last clicked button which represent category)
    ...
    /**
     * Method which gets from categoriesPanel information if user want to see tasks from one of the categories.
    ...
    /**
     * Method which is getting from addCategoriesPanel information if user added new category and frame needs to be refreshed to show it.
    ...
    /**
     * Method which call method from categoriesPanel to reset it's variable doWeRefresh to default value.
     */
